...
public static final String USER_DIR = "user.dir";
	...
	public static final String IEDRIVER_PATH = System.getProperty(USER_DIR) + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "drivers" + File.separator + "IEDriverServer.exe";
	public static final String GECKODRIVER_PATH = System.getProperty(USER_DIR) + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "drivers" + File.separator + "geckodriver.exe";
	...
	public static final String BROKEN_IMAGE_DIRECTORY_PATH = System.getProperty(USER_DIR) + File.separator + "broken-image";
	public static final String CURRENT_BROKEN_IMAGE_DIRECTORY_PATH = BROKEN_IMAGE_DIRECTORY_PATH+ File.separator +CommonUtils.getCurrentDate();
