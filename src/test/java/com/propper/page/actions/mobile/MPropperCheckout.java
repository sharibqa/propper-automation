...
public class MPropperCheckout extends PropperCheckout {

    private static final Logger LOGGER = LoggerFactory.getLogger(MPropperCheckout.class);
    ...
    public MPropperCheckout(WebDriver driver) {
        super(driver);
    }

    public void setQuantity(String qty) {
        waitForElementPresence("//input[@id='qty']_xpath", 30);
        WebElement element = scrollingToElementofAPage(qtyInputBox);
        clearTextBox("//input[@id='qty']_xpath");
        enterTxt(element, qty);

    }

    public void addtoCart() {
        sleep(5);
        WebElement element = scrollingToElementofAPage(addToCartButton);
        click(element);
        sleep(5);
        switchToTab();
    }
